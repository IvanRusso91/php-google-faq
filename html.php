...
$db=[
  ...
  [
    "titolo" => "<h4>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h4>",
    "testo" => " <p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
  ...
  [
    "titolo" => "<h4>Perché il mio account è associato a un paese?</h4>",
    "testo" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
